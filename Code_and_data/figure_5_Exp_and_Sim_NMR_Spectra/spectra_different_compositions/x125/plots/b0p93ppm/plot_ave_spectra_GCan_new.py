...
df2 = pd.read_csv('exp_data_0p125.csv', delimiter=';', names=['expx','expspec']) 
...
ax.invert_xaxis()   
plt.title('x=0.125  Sigma=0.94ppm  GrandCanonical')
plt.savefig('x125_b0p93_GCan.png')
plt.plot(c1,c2)
plt.xlim(-680.0, -620.0)
plt.show()
